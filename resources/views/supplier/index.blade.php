...
<header class="header" style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1rem;">
    <div>
        <h1 style="font-family:'Poppins',sans-serif; color:var(--warna-utama); font-size:2rem;">Manajemen Supplier</h1>
...
<div class="kartu">
    <h2 class="kartu__judul">Daftar Supplier</h2>
    <table class="tabel">
        <thead>
            <tr>
                <th>ID</th>
        ...
        @empty
            <tr>
                <td colspan="4" style="text-align:center; padding:2rem;">Belum ada supplier. Silakan tambahkan.</td>
            </tr>
        @endforelse
        </tbody>
    </table>
